    ...
    const performBooking = async () => {
        if(userId){
            if(dateRange.startDate && dateRange.endDate){
                ...
                if(response.success){
                    console.log('finished booking :D')
                } else {
  ...
  return (
    <aside className='mt-6 p-6 col-span-2 rounded-xl border border-gray-300 shadow-xl'>
        ...
        <div className='mb-6 p-3 border border-gray-400 rounded-xl'>
            ...
            <select value={guests} onChange={(e) => setGuests(e.target.value)} name="" id="" className='w-full ml-1 text-sm'>
        ...
        <div 
            ...
            className='w-full mb-6 py-6 text-center text-white bg-[var(--color-airbnb)] hover:bg-[var(--color-airbnb-dark)] cursor-pointer rounded-xl'>Book</div>
