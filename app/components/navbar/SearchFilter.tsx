    ...
    <div 
      ...
      <div className='hidden lg:block'>
        <div className='flex flex-row items-center justify-between'>
            ...
            <div className='h-[48px] lg:h-[64px] px-8 flex flex-col rounded-full hover:bg-gray-100 cursor-pointer justify-center'>
      ...
      <div className='p-2'>
        <div className='p-2 lg:p-4 bg-[var(--color-airbnb)] hover:bg-[var(--color-airbnb-dark)] cursor-pointer rounded-full text-white'>
            <svg 
            viewBox="0 0 32 32" 
