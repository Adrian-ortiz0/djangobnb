...
const UserNav: React.FC<UserNavProps> = ({
  ...
  return (
    <div className='p-2 relative inline-block border border-gray-100 rounded-full cursor-pointer'>
        <button
         onClick={() => setIsOpen(!isOpen)}
         className='flex items-center'>
            <svg fill="none" cursor="pointer" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
