    ...
    const content = (
        <>
            <form action={submitLogin} className="space-y-4">
                ...
                <input onChange={(e) => setPassword(e.target.value)} placeholder="Your password" type="password" className="w-full h-[54px] mb-3 p-4 border border-gray-300 rounded-xl" />
